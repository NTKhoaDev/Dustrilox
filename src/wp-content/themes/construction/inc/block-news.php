	...
	<div class="container-fluid">
		<div class="news-wrap section">
			<div class="container-inner">
				...
				<div class="row-news row row-small">
					...
					if ( $getposts->have_posts() ) :
						while ( $getposts->have_posts() ) :
							...
							?>
					<div class="col-4 col-news col-small">
						<a href="<?php echo esc_attr( get_permalink() ); ?>" class="col-inner radius">
							...
							<div class="news-content">
								...
								<?php echo esc_html( $link ); ?>
									<img src="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/next-arrow-white.svg" alt="icon-readmore" class="icon-white">
									<img src="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/next-arrow.svg" alt="icon-readmore" class="icon-grey">
								</div>
							</div>
						</a>
					</div>
